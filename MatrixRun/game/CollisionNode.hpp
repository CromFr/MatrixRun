#ifndef COLLISIONNODE_HPP_INCLUDED
#define COLLISIONNODE_HPP_INCLUDED
...
namespace game
{
	...
	**/
	class CollisionNode : public irr::scene::IEmptySceneNode
	{
	public:
		/**
		...
		**/
		CollisionNode(	irr::scene::ISceneNode* parent,
...
#endif // COLLISIONNODE_HPP_INCLUDED
